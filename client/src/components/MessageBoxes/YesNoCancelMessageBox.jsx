...
const YesNoCancelMessageBox = forwardRef((props, ref) => {
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={props.cancelCallback}>Cancel</button>
                    </div>
                </div>
            </div>
        </div>
...
YesNoCancelMessageBox.propTypes = {
    id: PropTypes.string,
...
export default YesNoCancelMessageBox;